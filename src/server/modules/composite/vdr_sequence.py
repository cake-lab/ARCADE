# code adapted from https://github.com/nianticlabs/implicit-depth/blob/main/inference/vdr_sequence.py
...
class VDRSequence:
    ...
    def load_obj_location(self, frame: dict) -> np.ndarray:
        return np.array(frame["objPosition"])